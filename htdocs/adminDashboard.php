...
?>
    ...
    <div class="profileHeading">
      ...
      <a class="medicalAnchor" href="questionnaire.php"><h3 class="supportBtn">Medical Support</h3></a>
    ...
    <a class="allUsersAnchor" href="adminUserControl.php"><button type="button" name="button" class = "allUsersBtn">View all User Details</button></a>
